...
export const identityReader: DocumentReader<IdentityReading> = {
  ...
  progressLabels: {
    documentType: "Working out what kind of ID this is…",
    fullName: "Reading the name…",
    dateOfBirth: "Reading the date of birth…",
    nationality: "Reading the nationality…",
    documentNumber: "Reading the document number…",
    expiryDate: "Checking the expiry date…",
